...
Route::group([
    ...
    Route::get('/purchase', ['as' => 'install.purchase', 'uses' => 'InstallPurchaseController@index']);
    Route::post('/purchase', ['as' => 'install.setPurchase', 'uses' => 'InstallPurchaseController@setPurchase']);
