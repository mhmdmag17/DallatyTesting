                            ...
                            <div class="card-body">
                                <div class="form-group row mandatory">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-4 mt-2">
                                        <label class="col-sm-12 form-label-mandatory " for="currency-code">{{ __('Currency Name') }}</label>
                                        <select id="currency-code" class="form-select form-control-sm select2" name="currency_code">
                                    ...
                                    {{-- Currency Symbol --}}
                                    <div class="col-sm-12 col-md-6 col-lg-4 mt-2">
                                        <label class="col-sm-12 form-label-mandatory " for="curreny-symbol">{{ __('Currency Symbol') }}</label>
                                        <input name="currency_symbol" type="text" id="currency-symbol" class="form-control" placeholder="{{ __('Currency Symbol') }}" data-parsley-required="true" maxlength="3">
                                    </div>
                                    ...
                                    {{-- Number With Suffix --}}
                                    <div class="col-sm-12 col-md-6 mt-2">
                                        <label class="col-sm-4 form-check-label mandatory" for="switch_number_with_suffix">{{ __('Number With Suffix') }}</label>
                                    ...
                                    {{-- Distance Options --}}
                                    <div class="col-sm-12 col-md-6 mt-2">
                                        <label class="col-sm-12 form-label-mandatory mt-3" for="distance-option">{{ __('Distance Options') }}</label>
                                        <select name="distance_option" id="distance-option" class="choosen-select form-select form-control-sm">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        {{-- Paypal Web URL --}}
                        <div class="col-sm-12 col-md-6 mt-2">
                            <label class="form-label">{{ __('Paypal Web URL') }}</label>
                            <input name="paypal_web_url" id="paypal-web-url" type="text" class="form-control" placeholder="{{ __('Paypal Web URL') }}" value="{{ ( system_setting('paypal_web_url') != '' ? system_setting('paypal_web_url') : '' )}}">
                        </div>
                ...
                if (event.target.checked) {
                    checkboxes.forEach((checkbox) => {
                        if (checkbox !== event.target) {
                            ...
                            if($("#switch_paypal_gateway").is(':checked')){
                                $("#paypal_gateway").val(1)
                                $("#paypal-web-url").attr('required',true);
                            }else{
                                $("#paypal_gateway") .val(0)
                                $("#paypal-web-url").removeAttr('required');
                            }
