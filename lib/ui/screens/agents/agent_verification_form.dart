          ...
          children: [
            ...
            if (state.hasError)
              Padding(
                ...
                child: Text(
                  state.errorText!,
                  style: TextStyle(color: context.color.error, fontSize: 12),
                ),
              ),
            const SizedBox(height: 10),
          ],
  ...
  Future<void> _pickDocument(
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('${'defaultErrorMsg'.translate(context)}: $e')),
      );
    }
  }
    ...
    try {
      if (_formKey.currentState!.validate()) {
        ...
        if (fetchFormFieldsState is FetchAgentVerificationFormFieldsSuccess) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('unableToSubmitForm'.translate(context)),
            ),
          );
        }
      }
