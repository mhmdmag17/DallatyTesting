        ...
        children: [
          GestureDetector(
            onTap: () {
              ...
              UiUtils.showFullScreenImage(
                context,
                provider: NetworkImage(widget.property?.customerProfile ?? ''),
              );
            },
            child: Container(
              width: 70,
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          UiUtils.showBlurredDialoge(
                            context,
                            dialoge: BlurredDialogBox(
                              title: 'agentName'.translate(context),
