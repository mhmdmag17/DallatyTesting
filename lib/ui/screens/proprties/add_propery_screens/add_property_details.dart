...
class _AddPropertyDetailsState extends State<AddPropertyDetails> {
  ...
  List<Widget> documentsList() {
    return documentFiles.map((documents) {
      return ListTile(
        title: Text(documents.name).setMaxLines(lines: 2),
        dense: true,
        trailing: IconButton(
  ...
  Widget build(BuildContext context) {
    final requiredSymbol = const Text('*').color(Colors.redAccent);
    return Scaffold(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(UiUtils.translate(context, 'slugIdLbl')),
                SizedBox(
                  height: 15.rh(context),
                ),
                CustomTextFormField(
                ...
                Row(
                  children: [
                    Expanded(
                      child: Text('Is Private Property?'.translate(context)),
                    ),
                    CupertinoSwitch(
                ...
                Text('propertyDocuments'.translate(context)),
                SizedBox(
                  height: 10.rh(context),
                ),
    ...
    return InputDecorator(
      ...
      child: DropdownButton<int>(
        ...
        items: [
          DropdownMenuItem(
            value: 0,
            child: Text('Sell'.translate(context)),
          ),
          DropdownMenuItem(
            value: 1,
            child: Text('Rent'.translate(context)),
          ),
        ],
        onTap: () {},
        onChanged: (int? value) {
