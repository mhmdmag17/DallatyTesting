                          ...
                          children: [
                            ...
                            if (hasDocuments()) ...[
                              Container(
                                ...
                                child: Text('Documents'.translate(context))
                            ...
                            if (hasFloors()) ...[
                              Container(
                                ...
                                height: 40,
                                width: MediaQuery.of(context).size.width,
                                child: Text('floorPlans'.translate(context))
                                    .size(context.font.large)
                                    .bold(),
                              ),
                              Container(
                            ...
                            Container(
                              ...
                              height: 40,
                              width: MediaQuery.of(context).size.width,
                              child: Text('projectLocation'.translate(context))
                                  .size(context.font.large)
                                  .bold(),
                            ),
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text('cityProj'.translate(context))
                                          .bold(),
                                      Text(project.city!),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      Text('stateProj'.translate(context))
                                          .bold(),
                                      Text(project.state!),
                                    ],
                                  ),
